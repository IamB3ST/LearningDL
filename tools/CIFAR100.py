...
class CIFAR100Trainer:
    def __init__(self, model, lr, loss, optimizer, batch_size, epoch, model_type, seed=1234):
        ...
        """data normalization"""
        self.mean = self.train_valid_data.data.mean(axis=(0, 1, 2)) / 255.0
        self.std = self.train_valid_data.data.std(axis=(0, 1, 2)) / 255.0


        """data augmentation"""
        self.train_transforms = torchvision.transforms.Compose([
            torchvision.transforms.RandomRotation(5, fill=(0, 0, 0)),
