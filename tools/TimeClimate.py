...
class climate_trainer:
    def __init__(self, model, lr, epoch, samples=5000, seed=1234):
        self.model = model
        ...
        """data normalization"""
        scaler = MinMaxScaler()
        self.temperatures_scaled = scaler.fit_transform(self.temperatures)
    ...
    def train(self):
        ...
        counter = 0
        lr = self.lr
        optimizer_f = optim.Adam(self.model.parameters(), lr=lr)
        for epoch in range(self.epoch):
            ...
            with torch.no_grad():
                for inputs, targets in valid_bar:
                    ...
                    valid_bar.set_postfix(val_loss=val_loss)
