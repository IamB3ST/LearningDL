...
class mnist_trainer:
    def __init__(self, model, lr, batch_size, epoch, train_transforms, test_transforms, seed=1234):
        ...
        ROOT = '.data'
        train_valid_data = torchvision.datasets.MNIST(root=ROOT, train=True, download=True, transform=train_transforms)
        test_data = torchvision.datasets.MNIST(root=ROOT, train=False, download=False, transform=test_transforms)
